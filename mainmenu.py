...
print(text.Text("Play Game", 50, text.GREEN).place(screen.get(), (
screen.get().get_rect().centerx, int(screen.get().get_rect().centery * (2. / 3)))))
print(text.Text("Load Game", 50, text.RED).place(screen.get(), (
screen.get().get_rect().centerx, int(screen.get().get_rect().centery * (4. / 3)))))
pygame.display.flip()
