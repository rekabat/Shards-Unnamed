...
from src.map.map_parser import parse
...
class Map:
    ...
    def getMapSizeTiles(self):
        return self.mapSizeTiles
    ...
    def tile2rect(self, x_y):
        return pg.Rect((x_y[0] * g.TILE_RES[0] + self.mapDrawingDif[0],
                        x_y[1] * g.TILE_RES[1] + self.mapDrawingDif[1]),
                       g.TILE_RES)
